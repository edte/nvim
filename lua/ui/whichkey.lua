...
wk.add({
	...
	{ "<leader>C", "<cmd>BufferCloseAllButCurrent<CR>", desc = "Close Other Buffer", nowait = true, remap = false },
	{ "<leader>c", "<cmd>bd<CR>", desc = "close Buffer", nowait = true, remap = false },
	{ "<leader>e", "<cmd>lua ToggleMiniFiles()<CR>", desc = "Explorer", nowait = true, remap = false },
	{ "<leader>f", "<cmd>lua project_files()<CR>", desc = "files", nowait = true, remap = false },
	{ "<leader>g", group = "git", nowait = true, remap = false },
	{ "<leader>gb", "<cmd>FzfLua git_branches<cr>", desc = "branch", nowait = true, remap = false },
	{ "<leader>gc", "<cmd>FzfLua git_commits<cr>", desc = "commit", nowait = true, remap = false },
	{ "<leader>gd", "<cmd>Gitsigns diffthis HEAD<cr>", desc = "diff", nowait = true, remap = false },
	{ "<leader>gl", "<cmd>lua require 'gitsigns'.blame_line()<cr>", desc = "blame", nowait = true, remap = false },
	{ "<leader>gs", "<cmd>FzfLua git_status<cr>", desc = "status", nowait = true, remap = false },
	{ "<leader>l", group = "lsp", nowait = true, remap = false },
	...
	{ "<leader>r", "<cmd>Telescope oldfiles<CR>", desc = "recents", nowait = true, remap = false },
	...
	{ "<leader>sa", "<cmd>FzfLua autocmds<cr>", desc = "autocmds", nowait = true, remap = false },
	...
	{ "<leader>t", "<cmd>FzfLua live_grep_native<CR>", desc = "text", nowait = true, remap = false },
	{ "<leader>L", "<cmd>edit" .. user_config_init .. "<CR>", desc = "config", nowait = true, remap = false },
})
